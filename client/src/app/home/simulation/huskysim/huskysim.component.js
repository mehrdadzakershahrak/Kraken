...
var HuskysimComponent = /** @class */ (function () {
    function HuskysimComponent(userService, rosService, hideservice, modal) {
    ...
    HuskysimComponent.prototype.ngDoCheck = function () {
    ...
    HuskysimComponent.prototype.onWindowResize = function () {
        var _this = this;
    ...
    HuskysimComponent.prototype.resizeViewer = function (widthMultiplier) {
    ...
    HuskysimComponent.prototype.ngOnInit = function () {
        this.loadAllUsers();
    ...
    HuskysimComponent.prototype.deleteUser = function (_id) {
        var _this = this;
        this.userService.delete(_id).subscribe(function () { _this.loadAllUsers(); });
    };
    HuskysimComponent.prototype.loadAllUsers = function () {
        var _this = this;
        this.userService.getAll().subscribe(function (users) { _this.users = users; });
    };
    HuskysimComponent.prototype.resizeWindow = function (input) {
    ...
    HuskysimComponent.prototype.resizeBox = function () {
        var _this = this;
    ...
    HuskysimComponent.prototype.modulo = function (a, b) {
        return a - Math.floor(a / b) * b;
    };
    HuskysimComponent.prototype.ToUint32 = function (x) {
        return this.modulo(this.ToInteger(x), Math.pow(2, 32));
    };
    HuskysimComponent.prototype.ToInteger = function (x) {
        x = Number(x);
    ...
    ], HuskysimComponent.prototype, "TLM", void 0);
    __decorate([
        core_1.HostListener('window:resize'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], HuskysimComponent.prototype, "onWindowResize", null);
    HuskysimComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return HuskysimComponent;
}());
exports.HuskysimComponent = HuskysimComponent;
//# sourceMappingURL=husky.component.js.map